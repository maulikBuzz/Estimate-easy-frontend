      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/admin/business-category" className=" waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("Business category")}</span>
              </Link>
            </li>

            
            <li>
              <Link to="/admin/merchant" className=" waves-effect">
            ...
            <li>
              <Link to="/admin/product" className=" waves-effect">
